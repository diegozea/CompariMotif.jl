...
@testitem "oracle exact-prefilter parity fixture" begin
    using Test
    using CompariMotif
    ...
    motifs_path = joinpath(root, "data", "fixtures", "exact_prefilter_probe_motifs.tsv")
    oracle_path = joinpath(root, "data", "fixtures", "oracle_exact_prefilter_probe_normalized.tsv")
