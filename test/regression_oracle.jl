...
@testitem "oracle regression fixture" begin
    using Test
    using CompariMotif
    ...
    motifs_path = joinpath(root, "data", "fixtures", "regression_motifs.tsv")
    oracle_path = joinpath(root, "data", "fixtures", "oracle_regression_normalized.tsv")
